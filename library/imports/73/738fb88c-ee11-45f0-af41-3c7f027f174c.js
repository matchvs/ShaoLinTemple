...
cc.Class({
    ...
    updateSelfScore: function updateSelfScore(num) {
        this.selfScore += num;
        if (this.selfScore < 0) {
            this.selfScore = 0;
        }
    ...
    updateOtherScore: function updateOtherScore(num) {
        this.otherScore += num;
    ...
    getPoolItem: function getPoolItem(pool, prefab) {
        var item = null;
        if (pool.size() > 0) {
            item = pool.get();
        } else {
    ...
    showAddRedNum: function showAddRedNum() {
    ...
    showReduceRedNum: function showReduceRedNum() {
    ...
    showBlueAddNum: function showBlueAddNum() {
    ...
    showReduceBlueNum: function showReduceBlueNum() {
    ...
    roleAlreadyAppear: function roleAlreadyAppear(event) {
    ...
    sitDownEvent: function sitDownEvent() {
        var msg = {
            action: GLB.SIT_DOWN
        };
        Game.GameManager.sendEventEx(msg);
    ...
    complacentEvent: function complacentEvent() {
        if (Game.GameManager.gameState !== GameState.Play) {
            return;
        }
        var msg = {
    ...
    randomAppearRole: function randomAppearRole() {
        var num = Math.random();
        var role = null;
        if (num < 0.25) {
    ...
    appearRole: function appearRole() {
        this.action = null;
    ...
    appearBesom: function appearBesom() {
    ...
    appearBrother: function appearBrother() {
        this.isNeedTiming = false;
    ...
    halfOpenDoor: function halfOpenDoor() {
        this.isNeedTiming = false;
    ...
    appearTeacher: function appearTeacher() {
        this.isNeedTiming = false;
